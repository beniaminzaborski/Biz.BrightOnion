...
namespace Biz.BrightOnion.Ordering.API.Infrastructure.AutofacModules
{
  public class MediatorModule : Autofac.Module
  {
    protected override void Load(ContainerBuilder builder)
    {
      ...
      //builder.RegisterAssemblyTypes(typeof(PublishIntegrationEventSlicePurchasedDomainEventHandler).GetTypeInfo().Assembly)
      //    .AsClosedTypesOf(typeof(INotificationHandler<>));
      //builder.RegisterAssemblyTypes(typeof(PublishIntegrationEventWhenNewOrderCreatedDomainEventHandler).GetTypeInfo().Assembly)
      //    .AsClosedTypesOf(typeof(INotificationHandler<>));
      //builder.RegisterAssemblyTypes(typeof(PublishIntegrationEventWhenOrderApprovedDomainEventHandler).GetTypeInfo().Assembly)
      //    .AsClosedTypesOf(typeof(INotificationHandler<>));
      //builder.RegisterAssemblyTypes(typeof(PublishIntegrationEventWhenSliceCanceledDomainEventHandler).GetTypeInfo().Assembly)
      //    .AsClosedTypesOf(typeof(INotificationHandler<>));
